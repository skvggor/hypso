...
Compose the wallpaper: output formats and aspect ratios, background fill, line color or gradient, and assembly of a single SVG that drives both preview and export.

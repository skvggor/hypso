...
Reproducibly build the site's static assets — Rust-generated OG image and poster, the WASM module and its JS glue — assemble them into a minified `dist/`, and deploy to GitHub Pages via a path-scoped workflow.
